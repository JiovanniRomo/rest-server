...
const actualizarRegistroPorId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const usuarioIdActualizando = (_b = req.usuario) === null || _b === void 0 ? void 0 : _b._id;
    try {
        ...
        const categoriaActualizada = yield Categoria.findByIdAndUpdate(id, { nombre: nombreActualizado, usuario: usuarioIdActualizando }, { new: true }).populate({
            path: 'usuario',
            select: 'nombre',
        });
        res.json({
